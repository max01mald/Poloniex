...
class Ticker:
    ...
    def WriteM(self):
        ...
        for market in self.Market:
            if not os.path.exists(os.path.dirname(os.path.realpath(__file__)) + market.Currency):
                os.makedirs(os.path.dirname(os.path.realpath(__file__)) + market.Currency)

            os.chdir(os.path.dirname(os.path.realpath(__file__)) + market.Currency)
    ...
    def ReadM(self, pair):
        name = "Ticker.txt"
        os.chdir(os.path.dirname(os.path.realpath(__file__)) + "/" + pair)
